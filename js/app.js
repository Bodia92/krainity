 ...
 */
    ...
    (() => {
            ...
            window.addEventListener("load", (function(e) {
                ...
                function getHeight(showMoreBlock, showMoreContent) {
                    ...
                    if (showMoreType === "items") {
                        ...
                        const showMoreTypeValue = showMoreContent.dataset.showmoreContent ? showMoreContent.dataset.showmoreContent : 72;
        ...
        function initSliders() {
            if (document.querySelector(".licenses__slider")) new swiper_core_Swiper(".licenses__slider", {
            ...
            if (document.querySelector(".why-us__slider")) new swiper_core_Swiper(".why-us__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 5,
...
***************************************************************************** */        var __assign = function() {
        ...
        const licenseSlider = document.querySelector(".licenses__slider");
        if (licenseSlider) {
            licenseSlider.querySelectorAll('a[data-gallery="certificate"]');
            lightgallery_es5(licenseSlider, {
                plugins: [ lg_thumbnail_min ],
                licenseKey: "7EC452A9-0CFD441C-BD984C7C-17C8456E",
                speed: 500,
                selector: 'a[data-gallery="certificate"]'
            });
        }
        window["FLS"] = true;
        menuInit();
